# Get Daily Transactions Stats By Contract

**`POST /{chain}/{network}/stats/getDailyTransactionsStatsByContract`**

Retrieves the daily transaction volume for a specific contract within the specified range.

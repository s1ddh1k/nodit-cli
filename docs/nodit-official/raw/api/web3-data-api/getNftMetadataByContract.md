...
| items[].rawMetadata | string | ✓ | A field representing the rawMetadata of the NFT. |
| items[].metadataSyncedAt | string | ✓ | A field representing when the metadata of the NFT was synchronized. |

...
**`POST /{chain}/{network}/nft/getNftTransfersByContract`**

Retrieves the list of NFT transfers that occurred from a specific contract. Results include contract metadata and NFT metadata.
